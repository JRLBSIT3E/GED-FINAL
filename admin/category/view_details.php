...
<section class="py-4">
    <div class="container">
        ...
        <div class="text-end pt-3">
            <a href=".?page=category/manage_category&id=<?= isset($id) ? $id : '' ?>" class="btn btn-primary bg-gradient btn-sm"><span class="material-icons">edit</span> Edit</a>
            ...
            <a href="./?page=category" class="btn btn-light border btn-sm"><span class="material-icons">arrow_back_ios</span> Back to List</a>
        </div>
    </div>
</section>
<script>
    $(function(){
        $('#delete_data').click(function(){
            _conf("Are you sure to delete this from list?","delete_category",['<?= isset($id) ? $id : '' ?>'])
        })
    })
