<section class="py-4">
    <div class="container">
        <h3 class="fw-bolder text-center">Category List</h3>
        <center>
...
<script>
    $(function(){
        $('.dt-init').DataTable({
            ...
            serverSide: true,
            ajax: {
                url:"../classes/Master.php?f=dt_category",
                method:"POST"
            },
            columns: [{
                    data: 'no',
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        el.find('.edit_data').attr("href","./?page=category/manage_category&id="+row.id)
                        el.find('.view_data').attr("href","./?page=category/view_details&id="+row.id)
            ...
            drawCallback: function(settings) {
                ...
                $('.delete_data').click(function(){
                    _conf("Are you sure to delete <b>"+$(this).attr('data-name')+"</b> from list?","delete_category",[$(this).attr('data-id')])
                })
            },
            language:{
                oPaginate: {
